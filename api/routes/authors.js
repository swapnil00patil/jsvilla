...
router.post('/', function(req, res, next) {
  ...
  db.query("INSERT INTO js_authors SET name="+ request.name +", description="+ request.description +", twitter_url="+ request.twitter_url +", github_url="+ request.github_url +"", function (err, result, fields) {
    if (err) throw err;
